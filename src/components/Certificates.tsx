...
import { X, ZoomIn, ZoomOut, Award, ArrowLeft, ArrowRight, RotateCcw, Download } from 'lucide-react';
...
const Certificates = () => {
  ...
  const handleNavigate = (direction: 'next' | 'prev') => {
    ...
    if (direction === 'next') {
        ...
        nextIndex = (currentIndex - 1 + certificates.length) % certificates.length;
    }
  ...
  return (
    <section id="certificates" className="py-20 bg-gray-800">
      ...
      <Dialog open={!!selectedCertificate} onOpenChange={(isOpen) => { if (!isOpen) handleClose(); }}>
          ...
          {selectedCertificate && (
            <TooltipProvider>
              <div className="flex items-center justify-between p-3 border-b border-gray-700 flex-shrink-0">
                  <h3 className="text-lg font-semibold ml-2 truncate" title={selectedCertificate.title}>
                  ...
                  <div className="flex items-center gap-1">
                      <Tooltip>
                          ...
                          <TooltipContent><p>Previous (Left Arrow)</p></TooltipContent>
                      </Tooltip>
                      <Tooltip>
                          <TooltipTrigger asChild>
                          ...
                          <TooltipContent><p>Next (Right Arrow)</p></TooltipContent>
                      </Tooltip>
                      ...
                      <Tooltip>
                          ...
                          <TooltipContent><p>Close (Esc)</p></TooltipContent>
                      </Tooltip>
                  </div>
              </div>
